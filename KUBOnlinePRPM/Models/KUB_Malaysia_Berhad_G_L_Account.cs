...
namespace KUBOnlinePRPM.Models
{
    ...
    public partial class KUB_Malaysia_Berhad_G_L_Account
    {
        ...
        public int Account_Subcategory_Entry_No_ { get; set; }
        public string Cost_Type_No_ { get; set; }
        public string Default_Deferral_Template_Code { get; set; }
        public string Division_Subsidiary { get; set; }
        public byte Replicate { get; set; }
        public System.DateTime Last_Replicated_Date_Time { get; set; }
        public byte Replicated_from { get; set; }
        public string Supply_Tax_Code { get; set; }
        public string Purchase_Tax_Code { get; set; }
        public string Ser__Cont__GST_Prod__P_Group { get; set; }
